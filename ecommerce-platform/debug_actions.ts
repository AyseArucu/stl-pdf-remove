...
export async function createOrder(formData: FormData) {
    ...
    try {
        ...
        return { success: false, message: 'SipariÅŸ oluÅŸturulamadÄ±' };
    }
}
...
export async function submitContactMessage(formData: FormData) {
    ...
    if (!name || !email || !message) {
        return { success: false, message: 'LÃ¼tfen tÃ¼m zorunlu alanlarÄ± doldurun.' };
    }
...
export async function updateProfile(formData: FormData) {
    const session = cookies().get('user_session')?.value;
    if (!session) return { error: 'Oturum aÃ§manÄ±z gerekiyor.' };
    const user = JSON.parse(session);
    ...
    try {
        ...
        return { error: 'Profil gÃ¼ncellenemedi.' };
    }
}
...
export async function changePassword(formData: FormData) {
    ...
    try {
        ...
        return { error: 'Åifre deÄŸiÅŸtirilemedi.' };
    }
}
...
export async function requestEmailChange(formData: FormData) {
    ...
    if (existing) return { error: 'Bu e-posta adresi zaten kullanÄ±mda.' };
    ...
    try {
        ...
        console.log(`Subject: E-posta DeÄŸiÅŸikliÄŸi OnayÄ±`);
        ...
        return { error: 'Ä°ÅŸlem baÅŸlatÄ±lamadÄ±.' };
    }
}
...
export async function createStlModel(formData: FormData) {
    ...
    if (!name || !file || !image) {
        return { error: 'LÃ¼tfen gerekli alanlarÄ± doldurun.' };
    }
    ...
    try {
        ...
        return { error: 'Dosya yÃ¼klenemedi.' };
    }
    ...
    try {
        ...
        return { error: 'GÃ¶rsel yÃ¼klenemedi.' };
    }
...
export async function deleteStlModel(formData: FormData) {
    ...
    try {
        ...
        if (!model) return { error: 'Model bulunamadÄ±.' };
...
export async function updateStlModel(formData: FormData) {
    ...
    try {
        ...
        if (!existing) return { error: 'Model bulunamadÄ±.' };
        ...
        if (file && file.size > 0) {
            try {
                ...
                return { error: 'Dosya gÃ¼ncellenemedi.' };
            }
        }
        ...
        if (image && image.size > 0) {
            try {
                ...
                return { error: 'GÃ¶rsel gÃ¼ncellenemedi.' };
            }
        }
...
export async function createHeroSlide(formData: FormData) {
    ...
    if (!image || image.size === 0) return { error: 'GÃ¶rsel zorunludur.' };
    ...
    try {
        ...
        return { error: 'Slayt oluÅŸturulamadÄ±.' };
    }
}
...
export async function updateHeroSlide(formData: FormData) {
    ...
    try {
        ...
        if (!existing) return { error: 'Slayt bulunamadÄ±.' };
        ...
        return { error: 'Slayt gÃ¼ncellenemedi.' };
    }
}
...
export async function deleteHeroSlide(formData: FormData) {
    ...
    try {
        ...
        if (!slide) return { error: 'Slayt bulunamadÄ±.' };
...
export async function getShippingSettings() {
    try {
        ...
        return { success: false, error: 'Kargo ayarlarÄ± getirilemedi.' };
    }
}
...
export async function updateShippingSettings(data: { shippingCost: number; freeShippingThreshold: number | null; isActive: boolean }) {
    try {
        ...
        return { success: false, error: 'Kargo ayarlarÄ± gÃ¼ncellenemedi.' };
    }
}
